    ...
    <>
      <div className={style.container}>
        ...
        <p className={style.p}>
          ...
          преимуществ агентства «PERSHIN&PARTNERS». Наша компания имеет законное
          право на оказание частных сыскных услуг физическим лицам и бизнесу.
          <br /> <br />
          Сотрудничество с лицензированными специалистами является для Заказчика
          одной из дополнительных гарантий ответственности и профессионализма.
        </p>
        </div>
      </div>
    </>
